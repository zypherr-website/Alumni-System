...
<body>
	<header class="header">
		<a href="./index.html"><img src="./img/plmun-logo-1.png" alt="plmun logo"></a>
	</header>
	...
	<main class="login-container">
		...
		<div class="ps">
			<p>If you forgot your username or password and you need an assistance to activate your account, please email us at <a href="#">support@plmun.edu.ph</a> using your official IE account. We will only entertain messages coming from PLMun official IE.</p>
		</div>
	</main>
</body>
</html>